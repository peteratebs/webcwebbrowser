...
#define EBS_LINT1    LINT1
#define EBS_LINT2    LINT2
#define EBS_DINT1    DINT1
#define EBS_DINT2    DINT2
#define EBS_STR1     STR1
#define EBS_STR2     STR2
#define EBS_IPADDR   IPADDR
#define EBS_IPV6ADDR IPV6ADDR
#define EBS_ETHERADDR  ETHERADDR
#define EBS_PKT        PKT
