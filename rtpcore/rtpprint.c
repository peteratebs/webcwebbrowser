...
* Function Prototypes
************************************************************************/
#if (RTP_INCLUDE_PRINTF || RTP_INCLUDE_SPRINTF)
...
#if ((RTP_INCLUDE_PRINTF || RTP_INCLUDE_SPRINTF) && (!defined (rtp_vprintf) || !defined (rtp_vsnprintf)))
...
#endif /* RTP_INCLUDE_SPRINTF */
#endif /* RTP_INCLUDE_PRINTF || RTP_INCLUDE_SPRINTF */
