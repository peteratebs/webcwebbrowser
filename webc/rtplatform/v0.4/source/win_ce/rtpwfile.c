...
************************************************************************/
int					     _rtp_windate_to_date         (time_t * windate, RTP_DATE * rtpdate);
int						 _rtp_date_to_windate         (RTP_DATE * rtpdate, time_t * windate);
unsigned short *		 _rtp_unicode_winname_to_name (unsigned short * name);
unsigned short *         _rtp_unicode_name_to_winname (unsigned short * name);
int						 _rtp_flag_to_operation       (unsigned short mode);
int						 _rtp_mode_to_permission      (unsigned short mode);
