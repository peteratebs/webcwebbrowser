...
char file_name[512];
    ...
    sprintf(file_name,"host:c:%s",name);

    fileHandle = open (file_name, _rtp_flag_to_operation(flag), _rtp_mode_to_permission(mode));
	printf("Opened |%s| resutl == %d\n", file_name, fileHandle);
