...
void RGB24To565::noDither(unsigned char * _dest, unsigned char * source, unsigned int width, unsigned int height)
{
	...
	for (; length != 0; length --)
	{
		*dest = RGBTO565(source[0],source[1],source[2]);
		source += 3;
		dest++;
	}
}

void RGB24To565::fsDither(unsigned char * dest, unsigned char * source, unsigned int width, unsigned int height)
{
/*
	int length = width * height;
...
void RGB24To565::orderedDither(unsigned char * dest, unsigned char * source, unsigned int width, unsigned int height)
{
	/*
	unsigned char r,g,b;
