...
#define NUM_EUC_KR_CHARS 8836
#define UNICODE_MAP_SIZE 8224
...
// EUC-KR charset is two bytes, both in the range: 0xA1-0xFE (94*94=8836 chars)

const unsigned short giEucKrtoUnicode [NUM_EUC_KR_CHARS] =
{
	0x3000, 0x3001, 0x3002, 0x00B7, 0x2025, 0x2026, 0x00A8, 0x3003, 
	0x2013, 0x2014, 0x2016, 0xFF3C, 0x301C, 0x2018, 0x2019, 0x201C, 
	...
	0x2103, 0x212B, 0x00A2, 0x00A3, 0x00A5, 0x2642, 0x2640, 0x2220, 
	...
	0x2283, 0x222A, 0x2229, 0x2227, 0x2228, 0x00AC, 0x21D2, 0x21D4, 
	...
	0xFF5D, 0x203E, 0x3131, 0x3132, 0x3133, 0x3134, 0x3135, 0x3136, 
...
unsigned short giUnicodeToEucKr [UNICODE_MAP_SIZE*2] =
{
	0x00A1, 0xA2AE,
	0x00A2, 0xA1CB,
	0x00A3, 0xA1CC,
...
{
    if (eucKr[0] < 0x80) /* Ascii - not sure check if upper or lower */
    {
    	uc[0] = (unsigned short) (eucKr[0]);
		return (1);
    }
    else if (eucKr[0] >= 0xa1 && eucKr[0] <= 0xfe && eucKr[1] >= 0xa1 && eucKr[1] <= 0xfe) 
    {
		int index = (eucKr[0] - 0xa1) * 94 + eucKr[1] - 0xa1;
    	uc[0] = giEucKrtoUnicode[index];
		return (2);
    }
...
unsigned short w;
    ...
    while (low <= high)
    {
        ...
        if (uc == giUnicodeToEucKr[midpoint << 1])
        {
            w = giUnicodeToEucKr[(midpoint << 1) + 1];
			eucKr[0] = (WEBC_UINT8) (w>>8);
			eucKr[1] = (WEBC_UINT8) (w&0xff);
			return (2);
        }
