 ...
 *
******************************************************************************/
/* MDI: The original file name is LPC23xx.H */
...
/* MDI: Added and changed for smxFS */
...
#define MCI_RESPCMD    (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x10))
#define MCI_RESPONSE0  (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x14))
#define MCI_RESPONSE1  (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x18))
#define MCI_RESPONSE2  (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x1C))
#define MCI_RESPONSE3  (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x20))
#define MCI_DATATIMER  (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x24))
#define MCI_DATALENGTH (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x28))
#define MCI_DATACTRL   (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x2C))
#define MCI_DATACNT    (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x30))
...
#define MCI_FIFOCNT    (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x48))
#define MCI_FIFO0      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x80))
#define MCI_FIFO1      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x84))
#define MCI_FIFO2      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x88))
#define MCI_FIFO3      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x8C))
#define MCI_FIFO4      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x90))
#define MCI_FIFO5      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x94))
#define MCI_FIFO6      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x98))
#define MCI_FIFO7      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0x9C))
#define MCI_FIFO8      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0xA0))
#define MCI_FIFO9      (*(volatile unsigned long *)(MCI_BASE_ADDR + 0xA4))
#define MCI_FIFO10     (*(volatile unsigned long *)(MCI_BASE_ADDR + 0xA8))
#define MCI_FIFO11     (*(volatile unsigned long *)(MCI_BASE_ADDR + 0xAC))
#define MCI_FIFO12     (*(volatile unsigned long *)(MCI_BASE_ADDR + 0xB0))
#define MCI_FIFO13     (*(volatile unsigned long *)(MCI_BASE_ADDR + 0xB4))
#define MCI_FIFO14     (*(volatile unsigned long *)(MCI_BASE_ADDR + 0xB8))
#define MCI_FIFO15     (*(volatile unsigned long *)(MCI_BASE_ADDR + 0xBC))
...
/* MDI: Changed for smxFS */
#define DMA_BASE_ADDR		0xFFE04000
#define DMA_CINTSTATUS         (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x000))
#define DMA_CINTTCSTATUS       (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x004))
#define DMA_CINTTCCLEAR        (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x008))
#define DMA_CINTERRSTAT        (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x00C))
#define DMA_CINTERRCLR         (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x010))
#define DMA_CRAWINTTCSTATUS    (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x014))
#define DMA_CRAWINTERRORSTATUS (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x018))
#define DMA_CENBLDCHNS         (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x01C))
#define DMA_CSOFTBREQ          (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x020))
#define DMA_CSOFTSREQ          (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x024))
#define DMA_CSOFTLBREQ         (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x028))
#define DMA_CSOFTLSREQ         (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x02C))
#define DMA_CCONFIGURATION     (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x030))
#define DMA_CSYNC              (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x034))

/* DMA channel 0 registers */
#define DMA_CC0SRCADDR       (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x100))
#define DMA_CC0DESTADDR      (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x104))
#define DMA_CC0LLI           (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x108))
#define DMA_CC0CONTROL       (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x10C))
#define DMA_CC0CONFIGURATION (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x110))
...
#define USB_CTRL_M      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x28))
...
/* MDI: Added for smxUSB */
#define MODULE_ID           (*(volatile unsigned long *)(SUD_LPC_BASE_ADDR + 0xFC))
...
/* MDI: Added for using the common code in smxUSBD */
#define I2C_TX      OTG_I2C_RX
#define I2C_STS     OTG_I2C_STS
#define I2C_CTL     OTG_I2C_CTL
#define I2C_CLKHI   OTG_I2C_CLKHI
#define I2C_CLKLO   OTG_I2C_CLKLO
