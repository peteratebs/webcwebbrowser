...
#ifdef __WEBC__
    return (JSHashEntry *) WEBC_JSMALLOC(JS_MAX(nbytes, sizeof(JSHashEntry)));
#else
...
#ifdef __WEBC__
            sfp = (ScriptFilenamePrefix *) WEBC_JSMALLOC(sizeof(ScriptFilenamePrefix));
#else
