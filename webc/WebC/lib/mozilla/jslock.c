...
{
#ifdef __WEBC__
    JSFatLock *fl = (JSFatLock *)WEBC_JSMALLOC(sizeof(JSFatLock)); /* for now */
#else
...
#ifdef __WEBC__
	global_locks = (PRLock **) WEBC_JSMALLOC(global_lock_count * sizeof(PRLock*));
#else
...
#ifdef __WEBC__
    fl_list_table = (JSFatLockTable *) WEBC_JSMALLOC(i * sizeof(JSFatLockTable));
#else
