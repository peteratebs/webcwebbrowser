...
/*---------------------------------------------------------------------------*
 * WEBC - JS_HAVE_LONG_LONG configuration
 *---------------------------------------------------------------------------*/
#if defined(EFI32)
...
#elif defined(WEBC_TRILITHIC_860DSP)
#undef JS_HAVE_LONG_LONG

#elif defined(__ICCARM__) // IAR (LPC2478)
#define JS_HAVE_LONG_LONG

#elif defined(__TIARM__) // Locosto
#define JS_HAVE_LONG_LONG
#else
#define JS_HAVE_LONG_LONG Chaqnge default
// #undef JS_HAVE_LONG_LONG

#endif /* WEBC JS_HAVE_LONG_LONG */

/*---------------------------------------------------------------------------*
 * WEBC - CPU configuration
 *---------------------------------------------------------------------------*/
#if defined(WEBC_TRILITHIC_860DSP)
...
#elif defined(WIN32) || (defined (__GNUC__)  &&  defined (__i386__))
...
#elif defined(_WIN32_WCE) // Windows CE environment
...
/* //BASA START*/
#elif defined(__vxworks__) //&& (CPU_FAMILY==SIMNT)// VxWorks VxSim
...
#elif defined(_EFT30_) //&& (CPU_FAMILY==SIMNT)// VxWorks VxSim
...
#error Fill in the following values for your target:
...
#elif defined(_WIN32) || defined(XP_OS2) || defined(WINCE) || defined(_M_IX86)
