...
#ifdef __WEBC__
        WEBC_JSCALLOC(JS_BIT(sizeLog2), sizeof(JSScopeProperty *));
#else
...
#ifdef __WEBC__
    table = (JSScopeProperty **) WEBC_JSCALLOC(nbytes, 1);
#else
...
#ifdef __WEBC__
    chunk = (PropTreeKidsChunk *) WEBC_JSCALLOC(1, sizeof *chunk);
#else
