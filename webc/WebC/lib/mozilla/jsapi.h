...
extern JS_PUBLIC_API(void *) _JSDB_malloc(JSContext *cx, size_t nbytes,char *file, long line);
#define JS_malloc(C,N) _JSDB_malloc(C,N,__FILE__,__LINE__)
#else
extern JS_PUBLIC_API(void *) _JSDB_malloc(JSContext *cx, size_t nbytes);
#define JS_malloc(C,N) _JSDB_malloc(C,N)
#endif
