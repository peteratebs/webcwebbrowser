...
#define WIN_NUM_STACKSIZE 5
const unsigned int stackSizeMap [WIN_NUM_STACKSIZE] = {
                               0x1000,
                               0x2000,
                               0x4000,
                               0x8000,
...
long stackSize;
    ...
    /* if large size passed in then it is stack size instead
       of index; RTIP old porting layer will pass stack size */
    if (stackSizeIndex > WIN_NUM_STACKSIZE)
    {
