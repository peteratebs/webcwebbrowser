...
#include "rtpstr.h"
#include "rtpmem.h" 
#include "rtip.h"    /* need malloc.h", tc_set_errno, xn_getlasterror etc */
#include "vfconf.h"
#include "vfapi.h"
...
long fileHandle;
    ...
    fileHandle = (long) vf_open((RTP_PFCHAR) name, (RTP_INT16) _rtp_flag_to_operation(flag), (RTP_INT16) _rtp_mode_to_permission(mode));
...
VDSTAT* nativeDirObj;
    ...
    nativeDirObj = (VDSTAT*) rtp_malloc(sizeof(VDSTAT), RTP_GFIRST_MALLOC);
