...
#include "rtpdebug.h"
#include "rtpterm.h"
#include "rtipconf.h" /* needed for INCLUDE_POLLOS_COOPERATIVE */
#include "pollos.h"   /* SPRZ */
...
int stackSizeMap[3] = 
{
    RTP_CFG_SIZESTACK_NORMAL, /* CFG_STACK_SIZE_NORMAL - KS_SIZESTACK_NORMAL */
    RTP_CFG_SIZESTACK_BIG,    /* CFG_STACK_SIZE_BIG - KS_SIZESTACK_BIG */
    RTP_CFG_SIZESTACK_HUGE    /* CFG_STACK_SIZE_HUGE - KS_SIZESTACK_HUGE */
};

int threadPriorityMap[3] =
{
	0, /* NORMAL */
	0, /* HIGH */
	0  /* HIGHEST */
...
int rtp_threads_up_cooperative = 0;
...
void rtp_thread_sleep (long msecs)
{
    ...
    {
        pollos_sleep(RTP_TIMEOUT_INFINITE);
    }
    else
    {
...
#if (INCLUDE_POLLOS_COOPERATIVE)  /* SPRZ */
...
RTP_HANDLE      old_level;
    ...
    rtp_printf("!!!! Thread spawned as a task\n");
