...
#define FILE_NAME_SIZE 350 //psmbfile.h has smb file name size defined, this has to be the
                            //same or double for unicode
/************************************************************************
* Types
************************************************************************/
...
{
	unsigned char realName[FILE_NAME_SIZE];
...
{
	unsigned char realName[FILE_NAME_SIZE];
	unsigned char newRealName[FILE_NAME_SIZE];
