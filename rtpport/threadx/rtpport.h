...
#define MCF52XX_CLOCK_PERIOD 20 /* Milliseconds */
#define MCF52XX_CLOCK_FREQUENCY 50 /* Ticks/sec */
#define RTKERNELRISC 1
...
#ifndef RTP_HANDLE_DEFINDED
#define RTP_HANDLE_DEFINDED 1 
...
#define RTP_CFG_SIZESTACK_HUGE     0x10000
#define RTP_CFG_N_STACKS_BIG       0
#define RTP_CFG_SIZESTACK_BIG      0xa000
#define RTP_CFG_N_STACKS_NORMAL    0
#define RTP_CFG_SIZESTACK_NORMAL   0x8000
#define RTP_CFG_N_STACKS_SMALL     5
#define RTP_CFG_SIZESTACK_SMALL    0x4000
#define RTP_CFG_N_STACKS_TINY      0
